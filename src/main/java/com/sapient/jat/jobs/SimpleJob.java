...
/**
 * <p>
 * A simple job configured in Spring. Just prints details about the job and when
...
public class SimpleJob implements Job {
	...
	public void execute(JobExecutionContext jobExecutionCntxt) throws JobExecutionException {
		logger.info("Job ** {} ** Trigger ** {} ** fired @ {}", jobExecutionCntxt.getJobDetail().getKey().getName(),
				jobExecutionCntxt.getTrigger().getKey().getName(), jobExecutionCntxt.getFireTime());
